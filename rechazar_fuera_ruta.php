...
if (empty($_POST["id_fuera_ruta"])) 
{
	...
	mysqli_close($enlace);
			...
			echo "<div class='main'>";
			echo "<h1>Solicitud rechazada exitosamente</h1>";
			echo "<div class='main-bdy'>";
			echo "<div class='main-body-left'>";
			...
			echo "</div>";
			echo "<div class='main-body-right'>";
				echo "<h2>Has rechazado la raz&oacute;n de fuera de ruta en este punto de venta, por lo tanto se contabilizar&aacute; como ruta no cumplida en dicho punto de venta.</h2>";
