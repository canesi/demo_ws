 ...
 * PHP Version 5
 * @package PHPMailer
 * @link https://github.com/PHPMailer/PHPMailer/ The PHPMailer GitHub 
project
...
"quoted-printable".
     ...
     * If not empty, will be sent via -f to sendmail or as 'MAIL FROM' 
in smtp mode.
     * @var string
     */
    public $Sender = '';
...
does anything.
     * @link https://tools.ietf.org/html/rfc5321#section-4.4 RFC5321 
reference
     */
    public $ReturnPath = '';
    /**
     ...
     * To generate iCal events, use the bundled extras/EasyPeasyICS.php 
...
http://sprain.ch/blog/downloads/php-class-easypeasyics-create-ical-files-with-php/
     ...
     * Set to 0 to not wrap. A useful value here is 78, for RFC2822 
section 2.1.1 compliance.
     * @var integer
     */
    public $WordWrap = 0;
    /**
...
value
    ...
    /**
     * SMTP hosts.
     * Either a single hostname or multiple semicolon-delimited 
hostnames.
