<?php
    ...
    $frecuencia10 = "Dia 3";
    $frecuencia20 = "Dia 7";
    $frecuencia30 = "Semana 2";
    $frecuencia40 = "Semana 3";
    $frecuencia50 = "Semana 4";
    ...
    if (mysqli_connect_errno()) {
      ...
      mysqli_query($enlace,$query);
    	...
    	if(strcmp($frecuencia,$frecuencia10)==0){//Dia 3
     		      $campov = "visita_dia_3";
                  queryv($visita,$campov,$master_plan,$enlace);
     	      }else if(strcmp($frecuencia,$frecuencia20)==0){//Dia 7
     		      $campov = "visita_dia_7";
                  queryv($visita,$campov,$master_plan,$enlace);
     	      }else if(strcmp($frecuencia,$frecuencia30)==0){//Semana 2
     		      $campov = "visita_semana_2";
                  queryv($visita,$campov,$master_plan,$enlace);
     	      }else if(strcmp($frecuencia,$frecuencia40)==0){//Semana 3
     		      $campov = "visita_semana_3";
                  queryv($visita,$campov,$master_plan,$enlace);
     	      }else if(strcmp($frecuencia,$frecuencia50)==0){//Semana 4
     		      $campov = "visita_semana_4";
    			  queryv($visita,$campov,$master_plan,$enlace);
     	}
      ...
      mysqli_close($enlace);
        ...
        function queryv($id_visita,$camp,$mpv,$enlv){
                if (mysqli_connect_errno()) {
                    echo "Fallo la conexion a la Base de datos";
                    exit();
                }else{
                  $query1v ="UPDATE master_plan SET ".$camp." = '".$id_visita."' WHERE id_master_plan = ".$mpv." ";
                  mysqli_query($enlv,$query1v);
                  echo $id_visita;
                }
        }
?>
