						...
						try
						{
							if($flag == True)
							{
								if($bandera_datos==true)
								{
									...
									$enviar-> enviarCorreo2("kevin.barrios@novaservicios.com.gt",null," REPORTE FALTANTE FARMACIAS ".$fecha,$body,$adjunto1,$no);
								...
								elseif ($bandera_datos==false)
								{
									...
									$enviar-> enviarCorreo("kevin.barrios@novaservicios.com.gt",null," REPORTE FALTANTE FARMACIAS ".$fecha,$body);
